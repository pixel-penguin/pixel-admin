    ...
    <div>
		<div class="row">
			...
			<div class="col-md-12 text-right m-b-30">
				<a href="/admin/products/create" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Add Product</a>
			</div>
		</div>
		...
		<div class="card">
            <div style="padding: 10px">
                <section>
                    ...
                    <v-client-table :columns="columns" v-model="products" :options="options">
                        ...
                        <div slot="actions" slot-scope="props">
                            <a :href="'/admin/products/'+props.row.id+'/edit'" data-original-title="null" class=" has-tooltip">
                                <i v-tooltip.top-center="'Edit this Calendar'" aria-hidden="true" class="fa fa-pencil-square-o" style="color: rgb(45, 150, 60);"></i>
                            </a> 
                            
                            <i @click="destroyProduct(props.row.id)" v-tooltip.top-center="'Delete this Calendar'" style="color:#CB2225; cursor:pointer" class="fa fa-trash-o" aria-hidden="true"></i>
                        </div>
    ...
    export default {
        ...
        methods:{
            ...
            destroyProduct(productId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/products/'+productId).then(response => {
								self.getAllProducts();
            ...
            activate(id){
                ...
                axios.post('/admin/products/activate',{
                    id:id,
                })
                .then(response => {
                   this.$swal({
