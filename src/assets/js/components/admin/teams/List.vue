    ...
    <div>
		<div class="row">
			...
			<div class="col-xs-8 text-right m-b-30">
				<a href="/admin/teams/create" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Add Team Member</a>
			</div>
		</div>
                    ...
                    <b-table
                        ...
                        <template slot-scope="props" visible="props.row.name.includes(searchKey) == true">
                            ...
                            <b-table-column label="Action">
                                ...
                                <a v-tooltip.top-center="'Edit Team Content'" :href="'/admin/teams/'+props.row.id+'/edit'"><i style="color:#2D963C" class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                ...
                                <i @click="destroyTeam(props.row.id)" v-tooltip.top-center="'Delete this Team'" style="color:#CB2225; cursor:pointer" class="fa fa-trash-o" aria-hidden="true"></i>
                            </b-table-column>
                        </template>
            ...
            destroyTeam(teamId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/teams/'+teamId).then(response => {
								self.getAllTeams();
