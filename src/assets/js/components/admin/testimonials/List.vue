		...
		<div>
            <div class="ui container">
                <section>
                    ...
                    <v-client-table :columns="columns" v-model="testimonials" :options="options">
                        ...
                        <div slot="actions" slot-scope="props">
                            <a :href="'/admin/testimonials/'+props.row.id+'/edit'" data-original-title="null" class=" has-tooltip">
