			...
			<div class="col-md-12">
				...
				<vue-nestable @change="saveOrder" v-model="pages">
                    ...
                    <strong class="nestAction">
                        ...
                        <a v-tooltip="'Edit Page'" :href="'/admin/mobilepages/'+item.id+'/edit/'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
    ...
    export default {
        ...
        methods:{
            ...
            destroyPage(pageId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/mobilepages/'+pageId).then(response => {
								self.getAllPages();
            ...
            saveOrder(){
                ...
                axios.post('/admin/mobilepages/order',{
            ...
            activate(id){
                ...
                axios.post('/admin/mobilepages/activate',{
                    id:id,
                })
                .then(response => {
                   this.$swal({
