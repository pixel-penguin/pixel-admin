                    ...
                    <b-table
                        ...
                        <template slot-scope="props" visible="props.row.name.includes(searchKey) == true">
                            ...
                            <b-table-column label="Action">
                                ...
                                <a v-tooltip.top-center="'Edit Special Content'" :href="'/admin/specials/'+props.row.id+'/edit'"><i style="color:#2D963C" class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                ...
                                <i @click="destroySpecial(props.row.id)" v-tooltip.top-center="'Delete this Special'" style="color:#CB2225; cursor:pointer" class="fa fa-trash-o" aria-hidden="true"></i>
                            </b-table-column>
                        </template>
