    ...
    <div>
		<div class="row">
            <div class="col-md-12">
                    ...
                    <li v-for="pageContent in pageContents"  v-bind:key="pageContent.id" class="list-group-item">
                        ...
                        <div class="row" v-if="pageContent.page_content_type_id == 1">
                            ...
                            <div class="col-xs-10 col-sm-10 col-md-10">     
                                ...
                                <div style="margin-top:10px" @click="pageContent.edit = false; saveContent(pageContent.id, pageContent.description)" v-if="pageContent.edit" class="btn btn-primary">Save</div>                        
                                <div @click="pageContent.edit = true" v-if="pageContent.edit == false" v-html="pageContent.description"></div>
                        ...
                        <div class="row" v-if="pageContent.page_content_type_id == 4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8"> 
                                        ...
                                        <div v-if="pageContent.edit" class="form-group">
                                            ...
                                            <input class="form-control" v-model="pageContent.description" />
                                        </div>
                                        <div v-if="pageContent.edit" class="form-group">
                ...
                <a :href="'/admin/mobilepages/'+page_id+'/edit/'" class="btn btn-primary">Go Back</a>
    ...
    export default {
        ...
        methods:{
            ...
            onUpdate: function (event) {
                ...
                axios.post('/admin/mobilepages/builder/order',{
            ...
            getContentTypes(){
                ...
                axios.get('/admin/json/getpagecontenttypesmobile')
                .then(response => {
                    //console.log(response);
            ...
            getContents(){
                ...
                axios.get('/admin/json/getpagecontentsmobile/'+self.page_id)
                .then(response => {
                    //console.log(response);
                    ...
                    self.pageContents.forEach(function(content) {
                        Vue.set(content, "edit", false);
                    });
                })
                .catch(error => {
                    console.log(error)
            ...
            addContentSection(contentTypeId){
                ...
                axios.post('/admin/json/addcontentsectionmobile',{
            ...
            destroyPageContent(pagecContentId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/json/removecontentsectionmobile/'+pagecContentId).then(response => {
								//self.getAllPages();
            ...
            uploadGallery(count = 0, pageContentId){
                ...
                if(count < self.galleryFiles.length){
                    ...
                    axios.post('/admin/mobilepages/builder/uploadgallery', formData,formData,
                    formData,
                    {
                        headers: {
            ...
            destroyGalleryFile(galleryId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/mobilepages/builder/gallery/delete/'+galleryId).then(response => {
            ...
            updateImage(id){
                ...
                axios.post('/admin/mobilepages/builder/image/update', 
                formData,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data'
