                    ...
                    <b-table
                        ...
                        <template slot-scope="props" visible="props.row.name.includes(searchKey) == true">
                            ...
                            <b-table-column label="Action">
                                ...
                                <a v-tooltip.top-center="'Edit Calendar Content'" :href="'/admin/calendars/'+props.row.id+'/edit'"><i style="color:#2D963C" class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                ...
                                <i @click="destroyCalendar(props.row.id)" v-tooltip.top-center="'Delete this Calendar'" style="color:#CB2225; cursor:pointer" class="fa fa-trash-o" aria-hidden="true"></i>
                            </b-table-column>
                        </template>
    ...
    export default {
        ...
        methods:{
            ...
            destroyCalendar(calendarId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/calendars/'+calendarId).then(response => {
								self.getAllCalendars();
            ...
            activate(id){
                ...
                axios.post('/admin/calendars/activate',{
                    id:id,
                })
                .then(response => {
                   this.$swal({
