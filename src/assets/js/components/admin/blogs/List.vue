    ...
    <div>
		<div class="row">
			...
			<div class="col-xs-8 text-right m-b-30">
				<a href="/admin/blogs/create" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Add Blog</a>
			</div>
		</div>
                    ...
                    <b-table
                        ...
                        <template slot-scope="props" visible="props.row.name.includes(searchKey) == true">
                            ...
                            <b-table-column label="Action">
                                ...
                                <a v-tooltip.top-center="'Edit Blog Content'" :href="'/admin/blogs/'+props.row.id+'/edit'"><i style="color:#2D963C" class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                ...
                                <i @click="destroyBlog(props.row.id)" v-tooltip.top-center="'Delete this Blog'" style="color:#CB2225; cursor:pointer" class="fa fa-trash-o" aria-hidden="true"></i>
                            </b-table-column>
                        </template>
    ...
    export default {
        ...
        methods:{
            ...
            destroyBlog(blogId){
				...
				this.$swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.value) {
                            axios.delete('/admin/blogs/'+blogId).then(response => {
								self.getAllBlogs();
            ...
            activate(id){
                ...
                axios.post('/admin/blogs/activate',{
                    id:id,
                })
                .then(response => {
                   this.$swal({
